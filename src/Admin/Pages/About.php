...
class About {
        ...
        public static function render() {
                $roadmap = array(
                        ...
                        array( 'v1.1.3', 'Fixes UX : indicateur drop temps réel + migration React 18 + ARIA propre', 'current' ),
                        array( 'v1.1.4', 'Live preview via iframe + postMessage', 'todo' ),
                        array( 'v1.1.5', 'Undo/Redo révisions WordPress + historique', 'todo' ),
