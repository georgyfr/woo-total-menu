...
class About {
        ...
        public static function render() {
                $roadmap = array(
                        ...
                        array( 'v1.1.2', 'Drag & drop arborescent + Undo/Redo + raccourcis clavier + a11y ARIA', 'current' ),
                        array( 'v1.1.3', 'Live preview via iframe + postMessage', 'todo' ),
                        array( 'v1.1.4', 'Undo/Redo révisions WordPress + historique', 'todo' ),
